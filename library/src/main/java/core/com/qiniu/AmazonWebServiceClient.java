...
import static core.com.qiniu.SDKGlobalConfiguration.PROFILING_SYSTEM_PROPERTY;
...
import core.com.qiniu.auth.RegionAwareSigner;
import core.com.qiniu.auth.Signer;
import core.com.qiniu.auth.SignerFactory;
import core.com.qiniu.handler.RequestHandler;
import core.com.qiniu.handler.RequestHandler2;
import core.com.qiniu.http.AmazonHttpClient;
...
public abstract class AmazonWebServiceClient {
    ...
    @Deprecated
    protected AmazonWebServiceClient(ClientConfiguration clientConfiguration,
            HttpClient httpClient, RequestMetricCollector requestMetricCollector) {
        this.clientConfiguration = clientConfiguration;
     ...
     *            {@link Region#getRegion(core.com.qiniu.regions.Regions)} for
     *            accessing a given region.
     * @throws IllegalArgumentException If the given region is null,
     *             or if this service isn't available in the given region. See
     *             {@link Region#isServiceSupported(String)}
     * @see Region#getRegion(core.com.qiniu.regions.Regions)
     * @see Region#createClient(Class,
     *      core.com.qiniu.auth.AWSCredentialsProvider, ClientConfiguration)
     */
     ...
     * the event for {@link core.com.qiniu.util.AWSRequestMetrics.Field#ClientExecuteTime} and call this method in a
     * try-finally block.
     *
