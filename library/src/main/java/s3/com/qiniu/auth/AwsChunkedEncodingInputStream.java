...
import core.com.qiniu.auth.AWS4Signer;
import core.com.qiniu.auth.SigningAlgorithm;
import core.com.qiniu.internal.SdkInputStream;
...
public final class AwsChunkedEncodingInputStream extends SdkInputStream {
    ...
    private byte[] createSignedChunk(byte[] chunkData) {
        ...
        String chunkSignature = BinaryUtils.toHex(aws4Signer.sign(chunkStringToSign, kSigning,
