...
import s3.com.qiniu.services.s3.internal.ObjectExpirationResult;
import s3.com.qiniu.services.s3.internal.ServerSideEncryptionResult;
...
import s3.com.qiniu.services.s3.model.CORSRule;
import s3.com.qiniu.services.s3.model.CanonicalGrantee;
...
import s3.com.qiniu.services.s3.model.EmailAddressGrantee;
...
import s3.com.qiniu.services.s3.model.MultipartUpload;
...
import s3.com.qiniu.services.s3.model.PartSummary;
import s3.com.qiniu.services.s3.model.Permission;
import s3.com.qiniu.services.s3.model.RedirectRule;
import s3.com.qiniu.services.s3.model.ReplicationDestinationConfig;
import s3.com.qiniu.services.s3.model.ReplicationRule;
import s3.com.qiniu.services.s3.model.RequestPaymentConfiguration;
import s3.com.qiniu.services.s3.model.RoutingRule;
import s3.com.qiniu.services.s3.model.RoutingRuleCondition;
import s3.com.qiniu.services.s3.model.S3ObjectSummary;
import s3.com.qiniu.services.s3.model.StorageClass;
import s3.com.qiniu.services.s3.model.TagSet;
...
//    }
    ...
    public static class CompleteMultipartUploadHandler extends AbstractSSEHandler
        ...
        /**
         * @see CompleteMultipartUploadResult#getExpirationTime()
         */
        @Override
        public Date getExpirationTime() {
        ...
        /**
         * @see CompleteMultipartUploadResult#setExpirationTime(Date)
         */
        @Override
        public void setExpirationTime(Date expirationTime) {
            if (result != null) {
        ...
        /**
         * @see CompleteMultipartUploadResult#getExpirationTimeRuleId()
         */
        @Override
        public String getExpirationTimeRuleId() {
        ...
        /**
         * @see CompleteMultipartUploadResult#setExpirationTimeRuleId(String)
         */
        @Override
        public void setExpirationTimeRuleId(String expirationTimeRuleId) {
            if (result != null) {
                ...
                if (name.equals("TopicConfiguration")) {
                    if (topic != null && event != null) {
                        configuration.getTopicConfigurations()
                                .add(new BucketNotificationConfiguration.TopicConfiguration(topic, event));
                    }
    ...
    public static class BucketLifecycleConfigurationHandler extends AbstractHandler {
        ...
        private final BucketLifecycleConfiguration configuration =
                new BucketLifecycleConfiguration(new ArrayList<BucketLifecycleConfiguration.Rule>());
            ...
            if (in("CORSConfiguration")) {
                ...
                if (name.equals("AllowedOrigin")) {
                    ...
                    if (allowedMethods == null) {
                        allowedMethods = new ArrayList<CORSRule.AllowedMethods>();
                    }
