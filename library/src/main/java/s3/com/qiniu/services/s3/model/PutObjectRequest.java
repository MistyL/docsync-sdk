...
import s3.com.qiniu.services.s3.model.ProgressListener;
...
public class PutObjectRequest extends AmazonWebServiceRequest implements Cloneable {
     ...
     * download status.
     */
    private core.com.qiniu.event.ProgressListener generalProgressListener;
    ...
    public void setProgressListener(
            core.com.qiniu.event.ProgressListener progressListener) {
     ...
     */
    @Deprecated
    public core.com.qiniu.event.ProgressListener getProgressListener() {
     ...
     */
    public void setGeneralProgressListener(core.com.qiniu.event.ProgressListener generalProgressListener) {
     ...
     * @return This updated PutObjectRequest object.
     */
    public PutObjectRequest withGeneralProgressListener(core.com.qiniu.event.ProgressListener generalProgressListener) {
