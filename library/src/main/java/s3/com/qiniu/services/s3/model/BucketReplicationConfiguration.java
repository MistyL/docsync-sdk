...
public class BucketReplicationConfiguration {
     ...
     *
     * @param roleARN The IAM role for this configuration.
     */
     ...
     *
     * @param id the unique identifier representing a rule in the replication
     *            configuration.
     ...
     *
     * @param rules the replication rules for the Amazon S3 bucket.
     ...
     * @param rule the replication rule for the Amazon S3 bucket.
