...
public class SetBucketReplicationConfigurationRequest extends AmazonWebServiceRequest {
     ...
     * Creates a new SetReplicationConfigurationRequest.
     *
     * @param bucketName The name of Amazon S3 bucket to which the replication
     *            configuration is set.
     * @param replicationConfiguration Replication configuration for an Amazon
     *            S3 bucket.
     */
     ...
     *
     * @param replicationConfiguration the replication configuration for an
     *            Amazon S3 bucket.
     */
