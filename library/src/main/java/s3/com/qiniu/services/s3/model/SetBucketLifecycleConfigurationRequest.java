 ...
 *
 * @see SetBucketLifecycleConfigurationRequest#SetBucketLifecycleConfigurationRequest(String,
...
public class SetBucketLifecycleConfigurationRequest extends AmazonWebServiceRequest {
    ...
    /**
     * Constructs a new {@link SetBucketLifecycleConfigurationRequest} to set
     ...
     *            configuration.
     * @param lifecycleConfiguration The new lifecycle configuration for this
     ...
     *
     * @param lifecycleConfiguration The new lifecycle configuration for the
     *            specified bucket.
     ...
     * @param lifecycleConfiguration The new lifecycle configuration for the
     *            specified bucket.
     * @return This {@link SetBucketLifecycleConfigurationRequest} object,
