...
import static core.com.qiniu.util.LengthCheckInputStream.EXCLUDE_SKIPPED_BYTES;
import static core.com.qiniu.util.LengthCheckInputStream.INCLUDE_SKIPPED_BYTES;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;

import core.com.qiniu.DefaultRequest;
import core.com.qiniu.HttpMethod;
import core.com.qiniu.event.ProgressEvent;
import core.com.qiniu.event.ProgressListenerCallbackExecutor;
import core.com.qiniu.event.ProgressReportingInputStream;
import core.com.qiniu.util.Base64;
import core.com.qiniu.util.ServiceClientHolderInputStream;
import s3.com.qiniu.services.s3.internal.BucketNameUtils;
import s3.com.qiniu.services.s3.internal.DigestValidationInputStream;
import s3.com.qiniu.services.s3.model.GetBucketReplicationConfigurationRequest;
import s3.com.qiniu.services.s3.model.GetRequestPaymentConfigurationRequest;
import s3.com.qiniu.services.s3.internal.InputSubstream;
import s3.com.qiniu.services.s3.internal.MD5DigestCalculatingInputStream;
import s3.com.qiniu.services.s3.internal.ObjectExpirationHeaderHandler;
import s3.com.qiniu.services.s3.internal.RepeatableFileInputStream;
import s3.com.qiniu.services.s3.internal.ResponseHeaderHandlerChain;
import s3.com.qiniu.services.s3.internal.S3ExecutionContext;
import s3.com.qiniu.services.s3.internal.S3ObjectResponseHandler;
import s3.com.qiniu.services.s3.internal.S3QueryStringSigner;
import s3.com.qiniu.services.s3.internal.S3StringResponseHandler;
import s3.com.qiniu.services.s3.internal.S3VersionHeaderHandler;
import s3.com.qiniu.services.s3.internal.ServerSideEncryptionHeaderHandler;
...
import s3.com.qiniu.services.s3.model.SetRequestPaymentConfigurationRequest;
...
import s3.com.qiniu.services.s3.model.GenericBucketRequest;
...
import s3.com.qiniu.services.s3.model.MultiFactorAuthentication;
import s3.com.qiniu.services.s3.model.PutObjectResult;
import s3.com.qiniu.services.s3.model.Region;
import core.com.qiniu.event.ProgressListener;
...
import core.com.qiniu.auth.AWSCredentialsProvider;
import core.com.qiniu.auth.DefaultAWSCredentialsProviderChain;
import core.com.qiniu.auth.Presigner;
import core.com.qiniu.auth.Signer;
import core.com.qiniu.auth.SignerFactory;
import core.com.qiniu.handler.HandlerChainFactory;
import core.com.qiniu.handler.RequestHandler2;
import core.com.qiniu.http.ExecutionContext;
import core.com.qiniu.http.HttpClient;
import core.com.qiniu.http.HttpMethodName;
import core.com.qiniu.http.HttpResponseHandler;
import core.com.qiniu.http.UrlHttpClient;
import core.com.qiniu.internal.StaticCredentialsProvider;
import core.com.qiniu.metrics.AwsSdkMetrics;
import core.com.qiniu.metrics.RequestMetricCollector;
import core.com.qiniu.regions.RegionUtils;
...
import core.com.qiniu.util.LengthCheckInputStream;
import core.com.qiniu.util.Md5Utils;
import core.com.qiniu.util.StringUtils;
import s3.com.qiniu.S3ClientOptions;
import s3.com.qiniu.services.s3.internal.AWSS3V4Signer;
import s3.com.qiniu.services.s3.internal.Constants;
import s3.com.qiniu.services.s3.internal.DeleteObjectsResponse;
import s3.com.qiniu.services.s3.internal.S3ErrorResponseHandler;
import s3.com.qiniu.services.s3.internal.S3MetadataResponseHandler;
import s3.com.qiniu.services.s3.internal.S3Signer;
import s3.com.qiniu.services.s3.internal.S3XmlResponseHandler;
import s3.com.qiniu.services.s3.internal.ServiceUtils;
import s3.com.qiniu.services.s3.internal.XmlWriter;
import s3.com.qiniu.services.s3.metrics.S3ServiceMetric;
import s3.com.qiniu.services.s3.model.AccessControlList;
import s3.com.qiniu.services.s3.model.AmazonS3Exception;
...
import s3.com.qiniu.services.s3.model.Grant;
import s3.com.qiniu.services.s3.model.Grantee;
...
import s3.com.qiniu.services.s3.model.RequestPaymentConfiguration;
import s3.com.qiniu.services.s3.model.ResponseHeaderOverrides;
import s3.com.qiniu.services.s3.model.RestoreObjectRequest;
import s3.com.qiniu.services.s3.model.S3AccelerateUnsupported;
import s3.com.qiniu.services.s3.model.S3Object;
import s3.com.qiniu.services.s3.model.S3ObjectInputStream;
import s3.com.qiniu.services.s3.model.SSECustomerKey;
...
import s3.com.qiniu.services.s3.model.transform.AclXmlFactory;
import s3.com.qiniu.services.s3.model.transform.BucketConfigurationXmlFactory;
import s3.com.qiniu.services.s3.model.transform.HeadBucketResultHandler;
import s3.com.qiniu.services.s3.model.transform.MultiObjectDeleteXmlFactory;
import s3.com.qiniu.services.s3.model.transform.RequestPaymentConfigurationXmlFactory;
import s3.com.qiniu.services.s3.model.Permission;
import s3.com.qiniu.services.s3.model.transform.RequestXmlFactory;
import s3.com.qiniu.services.s3.model.transform.Unmarshallers;
import s3.com.qiniu.services.s3.model.GroupGrantee;
import s3.com.qiniu.services.s3.model.transform.XmlResponsesSaxParser;
import s3.com.qiniu.services.s3.util.Mimetypes;
...
public class AmazonS3Client extends AmazonWebServiceClient implements AmazonS3 {
     ...
     * requests, but this can prove useful in some situations. For example:
     * <ul>
     * <li>If an Amazon S3 bucket has {@link s3.com.qiniu.services.s3.model.Permission#Read} permission for the
     * {@link GroupGrantee#AllUsers} group, anonymous clients can call
     * {@link #listObjects(String)} to see what objects are stored in a bucket.</li>
     * <li>If an object has {@link Permission#Read} permission for the
     * {@link GroupGrantee#AllUsers} group, anonymous clients can call
    ...
    @Override
    public void setRegion(core.com.qiniu.regions.Region region) {
    ...
    public CopyObjectResult copyObject(CopyObjectRequest copyObjectRequest)
        ...
        try {
            ...
            ResponseHeaderHandlerChain<XmlResponsesSaxParser.CopyObjectResultHandler> handler = new ResponseHeaderHandlerChain<XmlResponsesSaxParser.CopyObjectResultHandler>(
                    // xml payload unmarshaller
                    new Unmarshallers.CopyObjectUnmarshaller(),
                    // header handlers
                    new ServerSideEncryptionHeaderHandler<XmlResponsesSaxParser.CopyObjectResultHandler>(),
                    new S3VersionHeaderHandler(),
                    new ObjectExpirationHeaderHandler<XmlResponsesSaxParser.CopyObjectResultHandler>());
    ...
    public CompleteMultipartUploadResult completeMultipartUpload(
        ...
        @SuppressWarnings("unchecked")
        ResponseHeaderHandlerChain<XmlResponsesSaxParser.CompleteMultipartUploadHandler> responseHandler = new ResponseHeaderHandlerChain<XmlResponsesSaxParser.CompleteMultipartUploadHandler>(
                // xml payload unmarshaller
                new Unmarshallers.CompleteMultipartUploadResultUnmarshaller(),
                // header handlers
                new ServerSideEncryptionHeaderHandler<XmlResponsesSaxParser.CompleteMultipartUploadHandler>(),
                new ObjectExpirationHeaderHandler<XmlResponsesSaxParser.CompleteMultipartUploadHandler>());
        XmlResponsesSaxParser.CompleteMultipartUploadHandler handler = invoke(request, responseHandler, bucketName, key);
