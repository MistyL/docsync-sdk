...
public class ObjectListing {
     ...
     * reasons. Always check the {@link ObjectListing#isTruncated()} method to
     ...
     * {@link AmazonS3#listNextBatchOfObjects(ObjectListing)} to get additional
     * results.
     *
     ...
     *
     * @return The marker to use in the next <code>listObjects</code> request in
     *         order to see the next page of results if this object listing is
     *         truncated. Returns <code>null</code> if this object listing isn't
     *         truncated.
     */
     ...
     * listing.
     *
     * @param nextMarker The marker to use in the next listObjects request in
     ...
     * the objects listed in this S3ObjectListing.
     *
     * @param bucketName The name of the Amazon S3 bucket containing the objects
     *            listed in this S3ObjectListing.
     */
     ...
     * or <code>null</code> if no marker was specified. If specified, all
     ...
     * object listing, or the default <code>maxKeys</code> value provided by
     * Amazon S3 if the requester didn't specify a value. The
     * <code>maxKeys</code> parameter limits the combined number of objects and
     ...
     *
     * @return The <code>maxKeys</code parameter originally used to request this
     *         object listing. Returns the default <code>maxKeys</code> value
     *         applied by Amazon S3 if no value was specified.
     */
     ...
     *
     * @param maxKeys The <code>maxKeys</code> parameter originally used to
     *            request this object listing, or the default
     *            <code>maxKeys</code> value applied by Amazon S3 if the
