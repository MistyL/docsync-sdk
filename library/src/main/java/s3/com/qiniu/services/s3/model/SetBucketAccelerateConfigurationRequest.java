...
public class SetBucketAccelerateConfigurationRequest extends AmazonWebServiceRequest
     ...
     *            is being set.
     * @param configuration The new accelerate configuration for the specified
     *            bucket.
     */
     ...
     *
     * @return This {@link SetBucketAccelerateConfigurationRequest} object so
     ...
     *
     * @param accelerateConfiguration The new accelerate configuration for the
     *            specified bucket.
     */
     ...
     * {@link #setAccelerateConfiguration(BucketAccelerateConfiguration)}
     *
     * @return This {@link SetBucketAccelerateConfigurationRequest} object so
     *         that additional method calls may be chained together.
