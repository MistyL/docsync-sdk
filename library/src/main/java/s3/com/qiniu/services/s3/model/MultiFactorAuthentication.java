 ...
 * operations, see {@link BucketVersioningConfiguration} and the explanation of
...
public class MultiFactorAuthentication {
     ...
     * Authentication (MFA).
     *
     * @param deviceSerialNumber The serial number identifying the MFA device
     *            associated with the caller's AWS account.
     * @param token The current unique token generated by the MFA device.
     */
     ...
     * associated with the caller's AWS account.
     *
     * @param deviceSerialNumber The Multi-Factor Authentication device serial
     ...
     * this request. Returns this {@link MultiFactorAuthentication}, enabling
     * additional method calls to be chained together.
     *
     * @param deviceSerialNumber The serial number of the Multi-Factor
     ...
     *
     * @param token The current, unique Multi-Factor Authentication token
    ...
    /**
     * Sets the current, unique Multi-Factor Authentication token generated by
     * the device associated with the caller's AWS account. Returns this
     * {@link MultiFactorAuthentication}, enabling additional method calls to be
     * chained together.
     *
     * @param token The current, unique Multi-Factor Authentication token
     *            generated by the device associated with the caller's AWS
