...
import core.com.qiniu.auth.AWSSessionCredentials;
import core.com.qiniu.auth.AbstractAWSSigner;
import core.com.qiniu.auth.SigningAlgorithm;
import core.com.qiniu.util.HttpUtils;
import s3.com.qiniu.services.s3.Headers;

/**
 * Implementation of the {@linkplain core.com.qiniu.auth.Signer} interface specific to S3's signing
 * algorithm.
 */
