...
public class BucketAccelerateConfiguration {
    ...
    /**
     * @return The current status of the accelerate configuration for this
     *         bucket, or null if the bucket has never been enabled or suspended
    ...
    /**
     * A convenience method that returns whether the bucket is enabled
     * accelerate mode.
     *
     * @return True if the accelerate configuration has the
     *         {@link BucketAccelerateStatus#Enabled} status.
     */
