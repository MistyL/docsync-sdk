 ...
 * permissions to Amazon S3 buckets and objects. This enumeration contains all
 * the valid Amazon S3 group grantees.
 */
public enum GroupGrantee implements Grantee {
     ...
     * <code>AllUsers</code> group write access to their buckets. If granted,
     ...
     * bucket or object will be able to access it, users may find this
    ...
    /**
     * Gets the {@link GroupGrantee} enumeration value with the specified Amazon
     * S3 group URI (eg. http://acs.amazonaws.com/groups/global/AllUsers).
     * Returns <code>null</code> if an invalid Amazon S3 group URI is specified.
     *
     * @param groupUri A string representation of an Amazon S3 group URI (eg.
     *            http://acs.amazonaws.com/groups/global/AllUsers)
     * @return The {@link GroupGrantee} object represented by the given Amazon S3
     *         group URI string. Returns <code>null</code> if the string isn't a
     *         valid Amazon S3 group URI.
     */
