...
public class SetBucketAclRequest extends AmazonWebServiceRequest {
     ...
     *
     * @param bucketName The name of the bucket whose ACL will be set by this
     *            request.
     * @param acl The custom Access Control List containing the access rules to
     ...
     * @param bucketName The name of the bucket whose ACL will be set by this
     *            request.
     * @param acl The Canned Access Control List to apply to the specified
